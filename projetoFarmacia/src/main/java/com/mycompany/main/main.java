...
public class main {
        ...
        public static void main(String[] args) {
                ...
                String Telefone = JOptionPane
                                .showInputDialog("Passe o Telefone: \nSeguindo o padrão: (DD) XXXX-YYYY\n\n");
                        ...
                        if (selectedValue.equals("Adicionar Empregados")) {
                                int qtdaFuncionarios = Integer
                                                .parseInt(JOptionPane
                                                                .showInputDialog("Digite o número de funcionários:"));
                                for (int i = 0; i < qtdaFuncionarios; i++) {
                                        ...
                                        Object selectedFuncionario = JOptionPane.showInputDialog(null,
                                                        "Escolha uma opção", "Opção", JOptionPane.INFORMATION_MESSAGE,
                                        ...
                                        if (selectedFuncionario.equals("Farmacêutico")) {
                                                ...
                                                int certificacao = JOptionPane.showConfirmDialog(null,
                                                                "Possui certificado ?", "Confirmação",
                                                ...
                                                int vendas = Integer
                                                                .parseInt(JOptionPane.showInputDialog(null,
                                                                                "Digite o número de vendas: "));

                                                // Instanciando Func. do tipo Farmecêutico
                                                Funcionario addFuncionario = new Farmaceutico(NomeFarmacia, CNPJ,
                                                ...
                                                Funcionario addFuncionario = new Vendedor(NomeFarmacia, CNPJ, Endereco,
                                                                Telefone, Site,
